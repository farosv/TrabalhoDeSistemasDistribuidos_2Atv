...
* The original package name 'com.sd.fila-veiculos' is invalid and this project uses 'com.sd.filaveiculos' instead.
...
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/docs/2.7.13/reference/htmlsingle/#messaging.jms.activemq)
